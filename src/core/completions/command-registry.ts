...
/**
 * Registry of all synarcx CLI commands with their flags and metadata.
...
export const COMMAND_REGISTRY: CommandDefinition[] = [
  ...
  },
  {
    ...
    flags: [
      ...
      {
        name: 'concurrency',
        description: 'Max concurrent validations (defaults to env SYNARCX_CONCURRENCY or 6)',
        takesValue: true,
      },
  ...
  {
    name: 'change',
    description: 'Manage synarcx change proposals (deprecated)',
    flags: [],
    subcommands: [
      {
        name: 'show',
  ...
  {
    name: 'spec',
    description: 'Manage synarcx specifications',
    flags: [],
    subcommands: [
      {
        name: 'show',
